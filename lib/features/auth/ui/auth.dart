  ...
  Widget _title(){
    return Column(
      ...
      children: [
        ...
        Text("yor 're only a few steps from exchanging currency",style: TextModelStyle.whiteColor18BoldStyle(),textAlign: TextAlign.center),
        SizedBox(height: 24.0,),
        Text("create an account or login to continue with your transaction",style: TextModelStyle.whiteColor14MediumStyle(),textAlign: TextAlign.center),
      ],
    );
  }
