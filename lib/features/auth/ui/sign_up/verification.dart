...
class _VerificationPageState extends State<VerificationPage> {
  ...
  Widget build(BuildContext context) {
   ...
   Widget _confirmButton(){
     return Container(
         ...
         child: MaterialButton(
           ...
           child: Text("Continue",style: TextModelStyle.blackColor14BoldStyle(),),
         )
     );
   ...
   Widget _title(){
    return Column(
      children: [
        Text("Verify Your Email",style: TextModelStyle.blackColor20BoldStyle(),),
        Text("Please Enter the 4 digits code sent to email",style:TextModelStyle.black2Color14MediumStyle() ,)
      ],
    );
  }
